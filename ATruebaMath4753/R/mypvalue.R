#' mypvalue
#'
#' This function calculates the p-value given t_calc and produces a graph with the rejection region
#'
#' @param t0 the value of t_calc.
#' @param xmax
#' @param n the number of datapoints in the sample
#' @param alpha the confidence interval (alpha = 0.05 is a 95% ci)
#'
#' @return returs a plot with the p value and
#' @export
#'
#' @examples
